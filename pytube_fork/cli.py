...
from pytube_fork import __version__, CaptionQuery, Stream, Playlist
from pytube_fork import YouTube
from pytube_fork.exceptions import PytubeError
from pytube_fork.helpers import safe_filename, setup_logger
...
def _parse_args(
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "The list option causes pytube_fork cli to return a list of streams "
