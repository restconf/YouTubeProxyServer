# -*- coding: utf-8 -*-
"""
This module implements the core developer interface for pytube_fork.
...
from pytube_fork import Caption
from pytube_fork import CaptionQuery
from pytube_fork import extract
from pytube_fork import request
from pytube_fork import Stream
from pytube_fork import StreamQuery
from pytube_fork.extract import apply_descrambler, apply_signature, get_ytplayer_config
from pytube_fork.helpers import install_proxy
from pytube_fork.exceptions import VideoUnavailable
from pytube_fork.monostate import OnProgress, OnComplete, Monostate

logger = logging.getLogger(__name__)


class YouTube:
    """Core developer interface for pytube_fork."""
    ...
    def descramble(self) -> None:
        ...
        # https://github.com/nficano/pytube_fork/issues/165
