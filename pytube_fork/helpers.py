...
"""Various helper functions implemented by pytube_fork."""
import functools
import logging
import os
import re
...
from pytube_fork.exceptions import RegexMatchError
...
def setup_logger(level: int = logging.ERROR):
    ...
    # https://github.com/nficano/pytube_fork/issues/163
    logger = logging.getLogger("pytube_fork")
